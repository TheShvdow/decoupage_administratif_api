...
API REST construite avec **AdonisJS (TypeScript)** fournissant le découpage administratif complet du Sénégal : **régions, départements, communes et localités**.
...
* 🏘️ Liste des **46 départements** par région (avec code, coordonnées GPS et altitude)
* 🏠 Liste des **552 communes** avec coordonnées GPS et altitude
* 📌 Liste des **25 515 localités** rattachées aux communes
* 🔍 Recherche par nom dans les régions, départements, communes et localités (avec relations imbriquées)
...
|---------|----------|-------------|
| `GET` | `/api/v1/regions` | Liste des 14 régions (avec code, coordonnées GPS et altitude) |
...
| Méthode | Endpoint | Description |
|---------|----------|-------------|
| `GET` | `/api/v1/departements` | Liste de tous les départements (avec code, coordonnées GPS et altitude) |
...
| Méthode | Endpoint | Description |
|---------|----------|-------------|
| `GET` | `/api/v1/communes` | Liste de toutes les communes (avec coordonnées GPS et altitude) |
